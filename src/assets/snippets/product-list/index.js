...
define(['jquery', 'slick-carousel'], ($) => {
    ...
    $('.home .product-list__list, .product-list--related .product-list__list').find('.product-list__item--empty').remove();
    $('.home .product-list__list, .product-list--related .product-list__list').slick({
        slidesToShow: 4,
        slidesToScroll: 4,
